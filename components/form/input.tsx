...
export const Input = ({ name, label, placeholder, onChange, value, error, ...props }: InputProps) => {
  return (
    <div className="relative w-full">
      ...
      />
      {error && <p className="absolute text-yellow-600 dark:text-yellow-500 text-[10px] mt-0.5">{error}</p>}
    </div>
  )
}
